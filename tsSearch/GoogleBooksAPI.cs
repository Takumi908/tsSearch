...
namespace tsSearch
{
    ...
    class GoogleBooksAPI
    {
        ...
        public GoogleBooksAPI(string consumerKey) {
            ...
            // EndPointUrl = ($"https://www.googleapis.com/books/v1/volumes?q=search+title+{MainWindow.sctitle}=author+{MainWindow.scauthor}=isbn+{MainWindow.scisbn}&country=JP&langRestrict=ja&maxResults=40&key");
            ...
            if (MainWindow.sctitle == "" && MainWindow.scauthor == "" && MainWindow.scisbn != "") {
                EndPointUrl = ($"https://www.googleapis.com/books/v1/volumes?q=isbn:{MainWindow.scisbn}&key");
            }
        }
